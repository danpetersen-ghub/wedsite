...
<header class="bg-cover bg-center relative" style="background-image: url('hero.jpg');">
	...
	<div class="container mx-auto py-32 px-4 relative text-center">
		<h1 class="text-4xl lg:text-6xl  text-white leading-tight mb-4">Contact us</h1>
		<p class="text-xl lg:text-2xl text-white leading-tight mb-8 italic">15th June 2024</p>
	</div>
</header>

<div class="container mx-auto p-8 space-y-8 text-gray-600 text-center">
	<p class="">Should you have any questions or query's you can contact us at any time.</p>
	<p>
